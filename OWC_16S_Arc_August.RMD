...
otus <- otus[, grep("Aug-|Aug_", colnames(otus), ignore.case=TRUE, invert=FALSE)]
```
...
otus_D <- otus[, grep("-D1-", colnames(otus), ignore.case=TRUE, invert=FALSE)]
```
